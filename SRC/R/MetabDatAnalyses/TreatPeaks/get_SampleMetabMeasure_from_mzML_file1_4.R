...
sample_mzML_files_ <-
  RSFPath("TRUNK", "cWorks", "Project", "MetabolomeGeneral",
          "CE-MS", "STDs", "Cation",
          c("STD112.mzML", "100uM.mzML", "200uM.mzML"))
...
ref1_ <-
  SampleMetabMeasure(isamplenam = "Reference 1")
ref1_$set_annotlist(batch_$ref_annotlist)
ref1_$import_mzML_peak_range_info(
  ref_mzML_file_,
  ref_peak_range_info_file_) # ISs must be set.

smm1_ <- batch_$sample_metab_meas_list[[1]]
smm1_$find_bulk_peaks_all_ephe()
smm1_$find_IS_marks(batch_$ref_annotlist)
