...
source.RS("Usefuls1/FuncParam_simple1_1.R")

# For unit test, rsunit_test_Reijenga <- T and source it.
...
reijenga_map_from_ref <-
  function(r_t, ialpha, igamma){
    
    return(1 / (ialpha * (1/r_t + igamma / 2)))
    
  }


if(exists("rsunit_test_Reijenga") && rsunit_test_Reijenga){
